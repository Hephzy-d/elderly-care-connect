...
import { Heart, ArrowLeft, CalendarIcon, Clock, MapPin, Phone, MessageCircle, Plus } from "lucide-react"
import { getClientBookings } from "@/lib/services"
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Manage your upcoming appointments and care services</p>
        </div>
          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <CardContent>
                {selectedDateBookings.length > 0 ? (
                  <div className="space-y-4">
                    {selectedDateBookings.map((booking) => (
                      <div key={booking.id} className="flex items-center justify-between p-4 border rounded-lg">
                        <div className="flex items-center space-x-4">
                          <Avatar>
                            <AvatarImage src={booking.caregiver_profiles?.users?.avatar_url || "/placeholder.svg"} />
                            <AvatarFallback>
                              {`${booking.caregiver_profiles?.users?.first_name?.[0] || ""}${booking.caregiver_profiles?.users?.last_name?.[0] || ""}`}
                            </AvatarFallback>
                          </Avatar>
                          <div>
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-600 mb-4">You don't have any appointments scheduled for this date.</p>
                    <Link href="/client/book-service">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Your next scheduled care services</CardDescription>
              </CardHeader>
              <CardContent>
